...
packages\Pickles.CommandLine.1.2.3\tools\pickles.exe --feature-directory=api-acceptance-tests\Features --output-directory=Documentation --documentation-format=dhtml
